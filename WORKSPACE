...
# The plugin api for CLion 2019.3 EAP. This is required to build CLwB,
# and run integration tests.
http_archive(
    name = "clion_2019_3",
    build_file = "@//intellij_platform_sdk:BUILD.clion",
    sha256 = "45cddca0358cee8ad9973ecc26e098491961a79bd45e6d3730759dd9c3408d53",
    url = "https://download-cf.jetbrains.com/cpp/CLion-193.5096.27-jbr8.tar.gz",
)
...
http_archive(
    ...
    sha256 = "1da411fc5f175e263fb74bab96fd3d0b395a3027d4251b89694d45b9ed792700",
    url = "https://dl.google.com/dl/android/studio/ide-zips/3.6.0.15/android-studio-ide-192.5982640-linux.tar.gz",
)
