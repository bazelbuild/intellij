...
public class BlazeAndroidBinaryApplicationLaunchTaskProvider {
  ...
  public static BlazeLaunchTask getApplicationLaunchTask(
    ...
    return switch (configState.getMode()) {
      ...
      case BlazeAndroidBinaryRunConfigurationState.LAUNCH_SPECIFIC_ACTIVITY -> launchContext ->
      ...
      case BlazeAndroidBinaryRunConfigurationState.LAUNCH_DEEP_LINK -> launchContext ->
