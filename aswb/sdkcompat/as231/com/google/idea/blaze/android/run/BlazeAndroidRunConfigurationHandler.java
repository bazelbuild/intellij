...
public interface BlazeAndroidRunConfigurationHandler
    extends BlazeCommandRunConfigurationHandler, DeployableToDevice {
  /**
  ...
  /** @return If the configuration deploys to a local device */
