...
public class BlazeLightResourceClassService implements LightResourceClassService {
  ...
  @NotNull private Map<String, ModulePackageRClass> rClasses = Maps.newHashMap();
  ...
  public static class Builder {
    Map<String, ModulePackageRClass> rClassMap = Maps.newHashMap();
  ...
  public List<PsiClass> getLightRClasses(
    ...
    ModulePackageRClass rClass = this.rClasses.get(qualifiedName);
    if (rClass != null) {
