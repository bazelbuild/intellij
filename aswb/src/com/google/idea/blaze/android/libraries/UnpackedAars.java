...
public class UnpackedAars {
  ...
  private void refresh(
    ...
    try {
      ...
      Unpacker.unpack(projectState, updatedKeys, aarCache, removeMissingFiles);
    ...
    for (AarLibrary library : aarLibraries) {
      ...
      BlazeArtifact jar =
          library.libraryArtifact != null
              ...
              : null;
      outputs.put(
          UnpackedAarUtils.getAarDirName(aar),
          AarLibraryContents.create(aar, jar, library.key.toString()));
    }
