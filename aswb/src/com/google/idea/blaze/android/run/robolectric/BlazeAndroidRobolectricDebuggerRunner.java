...
/** Runner for debugging robolectric tests. */
public class BlazeAndroidRobolectricDebuggerRunner extends GenericDebuggerRunner {
  ...
  public String getRunnerId() {
    return "Blaze-Robolectric-Debug";
  }
  ...
  public boolean canRun(final String executorId, final RunProfile profile) {
    ...
    return kind != null && kind == RuleTypes.ANDROID_LOCAL_TEST.getKind();
  }
  ...
  public RunContentDescriptor createContentDescriptor(
    ...
    if (!(state instanceof BlazeAndroidRobolectricRunProfileState)) {
      return null;
    }
    BlazeAndroidRobolectricRunProfileState blazeState =
        (BlazeAndroidRobolectricRunProfileState) state;
  ...
  protected RunContentDescriptor doExecute(RunProfileState state, ExecutionEnvironment env)
    ...
    EventLoggingService.getInstance().logEvent(getClass(), "debugging-robolectric");
