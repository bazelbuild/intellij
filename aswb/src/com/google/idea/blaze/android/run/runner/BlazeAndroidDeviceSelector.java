...
/** Selects a device. */
public class BlazeAndroidDeviceSelector {

  /** A device session data class. */
  ...
  private static final Logger LOG = Logger.getInstance(BlazeAndroidDeviceSelector.class);
  ...
  private static boolean promptAndKillSession(
  ...
  private BlazeAndroidDeviceSelector() {}
}
