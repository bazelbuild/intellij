...
public final class BlazeResourceLibrary extends BlazeLibrary {
  ...
  private BlazeResourceLibrary(
      ArtifactLocation root, ImmutableSet<String> resources, @Nullable ArtifactLocation manifest) {
  ...
  static BlazeResourceLibrary fromProto(ProjectData.BlazeLibrary proto) {
    return new BlazeResourceLibrary(
        ArtifactLocation.fromProto(proto.getBlazeResourceLibrary().getRoot()),
        ImmutableSet.copyOf(proto.getBlazeResourceLibrary().getResourcesList()),
        ArtifactLocation.fromProto(proto.getBlazeResourceLibrary().getManifest()));
  }

  @Override
  public ProjectData.BlazeLibrary toProto() {
    ProjectData.BlazeResourceLibrary.Builder builder =
    ...
    return super.toProto().toBuilder().setBlazeResourceLibrary(builder.build()).build();
  }
