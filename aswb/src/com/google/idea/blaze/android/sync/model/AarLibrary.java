...
public final class AarLibrary extends BlazeLibrary {
  ...
  public AarLibrary(ArtifactLocation artifactLocation) {
    this(null, artifactLocation);
  }

  public AarLibrary(@Nullable LibraryArtifact libraryArtifact, ArtifactLocation aarArtifact) {
  ...
  static AarLibrary fromProto(ProjectData.BlazeLibrary proto) {
    return fromAarLibraryProto(proto.getAarLibrary());
  }

  @Override
  public ProjectData.BlazeLibrary toProto() {
    return super.toProto().toBuilder().setAarLibrary(toAarLibraryProto()).build();
  }

  static AarLibrary fromAarLibraryProto(ProjectData.AarLibrary aarLibrary) {
  ...
  public ProjectData.AarLibrary toAarLibraryProto() {
    ...
    return aarLibraryBuilder.build();
  }
  /**
  ...
  @Override
  public int hashCode() {
    return Objects.hashCode(aarArtifact);
  }
}
