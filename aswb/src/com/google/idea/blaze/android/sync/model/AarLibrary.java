...
public final class AarLibrary extends BlazeLibrary {
  ...
  public BlazeLibraryModelModifier getModelModifier(
    ...
    return new AarLibraryModelModifier(project, artifactLocationDecoder, modifiableModel);
  }
  ...
  /** An implementation of {@link BlazeLibraryModelModifier} for {@link AarLibrary}. */
  private final class AarLibraryModelModifier implements BlazeLibraryModelModifier {
    private final Project project;
    private final ArtifactLocationDecoder artifactLocationDecoder;
    private final Library.ModifiableModel libraryModel;

    AarLibraryModelModifier(
        Project project,
        ArtifactLocationDecoder artifactLocationDecoder,
        ModifiableModel modifiableModel) {
    ...
    public void updateModifiableModel() {
      ...
      File resourceDirectory =
          unpackedAars.getResourceDirectory(artifactLocationDecoder, AarLibrary.this);
      ...
      if (jar != null) {
        if (!jar.exists()) {
          logger.warn("Fail to find sourcejar: " + jar);
        } else {
      ...
      for (File sourceJar :
          unpackedAars.getCachedSrcJars(artifactLocationDecoder, AarLibrary.this)) {
        if (!sourceJar.exists()) {
    ...
    public boolean equals(Object other) {
      ...
      if (!(other instanceof AarLibraryModelModifier)) {
        return false;
      }

      AarLibraryModelModifier that = (AarLibraryModelModifier) other;
    ...
    @Override
    public int hashCode() {
      return Objects.hash(project, libraryModel);
    }
  }
}
