...
public class BlazeAndroidWorkspaceImporter {
  ...
  static class LibraryFactory {
    ...
    /**
     * Creates a new Aar repository for this ArtifactLocation. Returns the key for the library or
     * null if no aar exists for this target. Note that this function is designed for aar created by
