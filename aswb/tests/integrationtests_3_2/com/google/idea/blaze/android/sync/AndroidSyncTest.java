...
public class AndroidSyncTest extends BlazeSyncIntegrationTestCase {
  ...
  public void setup() {
    ...
    // CPPEnvironmentAdapter.registerForTest((MutablePicoContainer)ApplicationManager.getApplication().getPicoContainer());
  ...
  public void testMultipleToolchainsNoIssue() {
    ...
    assertThat(compilerSettings.getCompilerKey(OCLanguageKind.CPP, nativeCc).getValue())
