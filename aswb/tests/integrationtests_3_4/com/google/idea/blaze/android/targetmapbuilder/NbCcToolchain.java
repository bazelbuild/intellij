 ...
 */
public class NbCcToolchain implements TargetIdeInfoBuilderWrapper {
  ...
  public NbCcToolchain base_compiler_options(String... options) {
    cToolchainIdeInfoBuilder.addBaseCompilerOptions(ImmutableList.copyOf(options));
    return this;
  }
