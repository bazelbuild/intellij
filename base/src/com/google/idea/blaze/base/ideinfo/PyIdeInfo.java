...
public final class PyIdeInfo implements ProtoWrapper<IntellijIdeInfo.PyIdeInfo> {
  ...
  static PyIdeInfo fromProto(IntellijIdeInfo.PyIdeInfo proto) {
    ...
    return new PyIdeInfo(
        ...
        ImmutableList.copyOf(parseArgs(proto.getArgsList())));
  }

  /** Blaze has a layer of bash-like parsing to args - apply that here. */
  public static List<String> parseArgs(List<String> unparsedArgs) {
  ...
  public static List<String> encodeArgs(List<String> args) {
    return args.stream().map(BlazeParametersListUtil::encodeParam).collect(Collectors.toList());
  }
