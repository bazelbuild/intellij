 ...
 */
public class BuildEventProtocolRemoteTestFinderStrategy implements BlazeTestResultFinderStrategy {
  private static final Logger logger =
      Logger.getInstance(BuildEventProtocolLocalTestFinderStrategy.class);
  private final BuildEventStreamProvider streamProvider;

  public BuildEventProtocolRemoteTestFinderStrategy(BuildEventStreamProvider streamProvider) {
