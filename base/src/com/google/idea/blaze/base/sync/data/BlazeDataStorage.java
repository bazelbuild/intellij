...
public class BlazeDataStorage {
  ...
  public static final HashSet<String> ALL_PROJECT_SUBDIRECTORIES = getAllProjectSubdirectories();
  ...
  private static HashSet<String> getAllProjectSubdirectories() {
    HashSet<String> directories = new HashSet<>();
    directories.add(".ijwb");
    directories.add(".clwb");
    directories.add(".aswb");
    return directories;
  }
