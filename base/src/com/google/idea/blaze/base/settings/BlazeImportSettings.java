...
public final class BlazeImportSettings {
  ...
  // "sync.prototype.project.proto.enabled" AND the use selected the option to import from project
  // proto in the project creation wizard. All prototype functionality should be gated on this
  // being non-null to ensure prototype code does not cause problems whe not enabled.
