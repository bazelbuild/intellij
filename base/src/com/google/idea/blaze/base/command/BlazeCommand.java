...
public final class BlazeCommand {
  ...
  public static Builder builder(BazelBinary binary, BlazeCommandName name) {
    return new Builder(binary.getPath(), name);
  }

  /**
   * @deprecated Use {@link #builder(BazelBinary, BlazeCommandName)} instead.
   */
  @Deprecated
