...
public class IncludeKeywordCompletionTest extends BuildFileIntegrationTestCase {
  ...
  public void testIncludeKeywordCompletion() {
    createAndSetCaret(new WorkspacePath("MODULE.bazel"), "inclu<caret>");

    String[] completions = editorTest.getCompletionItemsAsStrings();
    assertThat(completions).asList().contains("include");
  }
  ...
  public void testIncludeKeywordInBuildFile() {
    ...
    createAndSetCaret(new WorkspacePath("BUILD"), "inclu<caret>");
