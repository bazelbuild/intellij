...
public class ChangeListEditorCompatUtils {
  ...
  public static List<EditorCustomization> getDescriptionEditorCustomizations(
    ...
    return ImmutableList.of(
        // TODO(grl): Switch to g3plugins.common.ui version once this is out of sdkcompat.
        SpellCheckingEditorCustomization.getInstance(/* enabled */ true),
        new RightMarginEditorCustomization(
            configuration.USE_COMMIT_MESSAGE_MARGIN,
