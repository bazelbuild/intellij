...
public class ScalaCompat {
    public static ScalaLibraryProperties scalaLibraryProperties(Option<String> libraryVersion) {
        return ScalaLibraryProperties.apply(libraryVersion, Seq$.MODULE$.<File>empty(), Seq$.MODULE$.<File>empty(), Option.empty(), ReplClasspath.fromPaths(Seq$.MODULE$.<File>empty()));
    }
}
