...
public class ChangeListManagerAdapter {
  ...
  public static void ensureUpToDate(Project project) {
    ChangeListManagerImpl.getInstanceImpl(project).ensureUpToDate(/* canBeCancelled= */ false);
  }
  ...
  public abstract static class TestChangeListManagerAdapter extends ChangeListManager {
    ...
    @Override // #api183: removed / moved in 2019.1 (only ChangeListManagerImpl)
    public boolean ensureUpToDate(boolean canBeCanceled) {
      throw new UnsupportedOperationException("TestChangeListManager#ensureUpToDate()");
    }
