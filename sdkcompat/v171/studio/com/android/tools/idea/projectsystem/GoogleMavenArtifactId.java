...
public enum GoogleMavenArtifactId {
  ...
  ESPRESSO_CORE("com.androidx.test.espresso", "espresso-core", false),
  ANDROIDX_ESPRESSO_CORE("androidx.test.espresso", "espresso-core", false),
  ESPRESSO_CONTRIB("com.androidx.test.espresso", "espresso-contrib", false),
  ...
  GoogleMavenArtifactId(
      String mavenGroupId, String mavenArtifactId, boolean isPlatformSupportLibrary) {
    this.mavenGroupId = mavenGroupId;
    this.mavenArtifactId = mavenArtifactId;
  }

  public GradleCoordinate getCoordinate(String revision) {
    return new GradleCoordinate(mavenGroupId, mavenArtifactId, revision);
  }
};
