...
public interface MergeSessionExAdapter extends MergeSessionEx {
  ...
  @Override
  default void acceptFilesRevisions(List<VirtualFile> list, Resolution resolution)
      throws VcsException {
    doAcceptFilesRevisions((List) list, resolution);
  }
  ...
  @SuppressWarnings({"unchecked", "rawtypes"})
  @Override
  default void conflictResolvedForFiles(List<VirtualFile> list, Resolution resolution) {
    doConflictResolvedForFiles((List) list, resolution);
  }
}
