...
public abstract class VcsRepositoryIgnoredFilesHolderBaseAdapter<RepositoryT extends Repository>
  ...
  public VcsRepositoryIgnoredFilesHolderBaseAdapter(
    ...
    super(repository, repositoryManager, updateQueueName, rescanIdentityName);
  }
  ...
  @Override
  protected Set<VirtualFile> requestIgnored(@Nullable Collection<? extends FilePath> collection)
      throws VcsException {
    return requestIgnoredVF(collection);
  }
}
