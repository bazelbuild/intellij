...
public abstract class VcsLogProviderAdapter implements VcsLogProvider {
  ...
  @Override
  public LogData readAllHashes(VirtualFile root, Consumer<? super TimedVcsCommit> commitConsumer) {
  ...
  @Override
  public void readAllFullDetails(
      VirtualFile root, Consumer<? super VcsFullCommitDetails> commitConsumer) throws VcsException {
