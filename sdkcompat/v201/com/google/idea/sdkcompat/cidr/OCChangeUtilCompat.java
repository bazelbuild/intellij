...
import com.jetbrains.cidr.lang.refactoring.util.OCChangeUtil.PostponedFormatAction;
...
public class OCChangeUtilCompat {
  ...
  public static PsiElement addHandlingMacros(
      ...
      boolean isBefore) {
    return OCChangeUtil.addHandlingMacros(
        parent, child, anchor, PostponedFormatAction.Format, isBefore);
  }
}
