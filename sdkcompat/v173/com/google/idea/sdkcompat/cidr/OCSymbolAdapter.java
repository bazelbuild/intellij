...
public class OCSymbolAdapter {
  ...
  public static OCSymbol<?> getDefinitionSymbol(
      OCSymbolWithQualifiedName<?> symbol, Project project) {
    return symbol.getDefinitionSymbol();
  }

  public static OCSymbolWithQualifiedName<?> getResolvedOwner(
      OCFunctionSymbol symbol, Project project) {
    return symbol.getResolvedOwner();
  }
}
