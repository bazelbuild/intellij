...
# https://github.com/grpc/grpc-java/blob/f67ec2ecd9c79e34c6fb989091dcf8862480e54d/java_grpc_library.bzl
# with only a single change:
# Label("//compiler:java_grpc_library_toolchain"),
# has been replaced with
# Label("//tools:java_grpc_library_toolchain"),
# to make use of the precompiled protoc binary.
...
_java_grpc_library = rule(
    attrs = {
        ...
        "_toolchain": attr.label(
            default = Label("//tools:java_grpc_library_toolchain"),
        ),
...
_java_lite_grpc_library = rule(
    attrs = {
        ...
        # This attribute has a "magic" name recognized by the native DexArchiveAspect (b/78647825).
        "_toolchain": attr.label(
            default = Label("//tools:java_lite_grpc_library_toolchain"),
        ),
        # TODO: Enable AEGs when Bazel 5.x support is dropped.
        "_use_auto_exec_groups": attr.bool(default = False),
    },
