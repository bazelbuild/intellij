...
EXISTING_EXTERNAL_TEST_VIOLATIONS = [
    ...
    "//javatests/com/google/devtools/intellij/g3plugins/services/buganizer:integration_tests",
    "//javatests/com/google/devtools/intellij/g3plugins/services/buganizer:medium_tests",
    "//javatests/com/google/devtools/intellij/g3plugins/services/buganizer:small_tests",
    "//javatests/com/google/devtools/intellij/g3plugins/services/buildservice:unit_tests",
    "//javatests/com/google/devtools/intellij/g3plugins/services/codefindings:unit_tests",
    "//javatests/com/google/devtools/intellij/g3plugins/services/codesearch:unit_tests",
    "//javatests/com/google/devtools/intellij/g3plugins/services/depserver:unit_tests",
    "//javatests/com/google/devtools/intellij/g3plugins/services/experiments:unit_tests",
...
def _restricted_test_deps_aspect_impl(target, ctx):
    ...
    outside_project = []
    for d in _get_deps(ctx):
        if not _in_tests(d) and not _in_set(d, _valid) and not _in_project(d):
            outside_project.append(d)
        if RestrictedInfo in d:
