...
def merge_dependencies_info(
    ...
    Args:
      target: the target label whose dependencies will be merged
      ctx: unused context
      java_dep_info: java dep info
      cc_dep_info: cc dep info
      cc_toolchain_dep_info: cc toolchain info

    Returns:
      Merged DependenciesInfo
    """
...
def one_of(a, b):
    ...
    Args:
      a: possible None value
      b: possible None value
