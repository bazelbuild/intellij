...
public class BazelPluginProcessorJarTest extends BazelIntellijAspectTest {
  ...
  private static final String JAR_STR =
      jarString("external/rules_jvm_external~5.3~maven~maven/com/google/auto/value/auto-value/1.10.4/processed_auto-value-1.10.4.jar", /*iJar=*/ null, /*sourceJar=*/ null);
  private static final String OUTPUT_GROUP_FILES = "../rules_jvm_external~5.3~maven~maven/com/google/auto/value/auto-value/1.10.4/processed_auto-value-1.10.4.jar";
