package com.google.devtools.intellij.blaze.plugin.aspect.go.golibrary;
...
public class GoLibraryTest extends BlazeIntellijAspectTest {
  @Test
  public void testGoLibrary() throws Exception {
    ...
    assertThat(getOutputGroupFiles(testFixture, "intellij-compile-go"))
        .containsAllOf(testRelative("simple.a"), testRelative("simple.x"));
