...
def _impl(ctx):
    ...
    asserts.equals(env, None, target_under_test[TargetsInfo].target_infos[0].cc_toolchain_target)
    ...
    asserts.equals(env, 1, len(jar_list))
    asserts.equals(env, "aspect/testing/tests/src/com/google/idea/blaze/aspect/java/javalibrary/libfoo-hjar.jar", jar_list[0].short_path)
