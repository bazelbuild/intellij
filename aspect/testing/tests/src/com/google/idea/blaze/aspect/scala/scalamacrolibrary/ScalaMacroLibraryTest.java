...
/** Tests scala_macro_library */
@RunWith(JUnit4.class)
public class ScalaMacroLibraryTest extends BazelIntellijAspectTest {
  @Test
  public void testScalaLibrary() throws Exception {
    ...
    assertThat(getOutputGroupFiles(testFixture, "intellij-resolve-java"))
        .containsAnyOf(testRelative("simple-srcjar.jar"), testRelative("simple-ijar.jar"));
