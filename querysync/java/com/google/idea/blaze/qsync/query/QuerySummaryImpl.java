 ...
 */
@AutoValue
public abstract class QuerySummaryImpl implements QuerySummary {
   ...
   * QuerySummaryImpl} using {@link QuerySummaryImpl#create(Query.Summary)}.
   */
  @Override
  ...
  public static QuerySummary create(Query.Summary proto) {
    return new AutoValue_QuerySummaryImpl(proto);
  }
  ...
  /**
   * Builder for {@link QuerySummaryImpl}. This should be used when constructing a summary from a map of
   * source files and rules. To construct one from a serialized proto, you should use {@link
   * QuerySummaryImpl#create(InputStream)} instead.
   */
  public static class Builder {
    ...
    public QuerySummary build() {
      ...
      return QuerySummaryImpl.create(builder.build());
    }
  }
