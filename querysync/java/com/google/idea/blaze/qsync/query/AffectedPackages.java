...
/**
 * Encapsulates build packages that affected by changes to files in the project view, and logic to
 * calculate that.
 */
public class AffectedPackages {

  private final ImmutableSet<Path> modifiedPackages;
  private final ImmutableSet<Path> deletedPackages;

  public static Builder newBuilder() {
    return new Builder();
  }

  public AffectedPackages(ImmutableSet<Path> modifiedPackages, ImmutableSet<Path> deletedPackages) {
    this.modifiedPackages = modifiedPackages;
    this.deletedPackages = deletedPackages;
  }

  public boolean isEmpty() {
    return modifiedPackages.isEmpty() && deletedPackages.isEmpty();
  }

  public ImmutableSet<Path> getModifiedPackages() {
    return modifiedPackages;
  }

  public ImmutableSet<Path> getDeletedPackages() {
  ...
  public static class Builder {
    ...
    private ImmutableList<Path> projectExcludes;
    private QuerySummary lastQuery;
    private ImmutableCollection<WorkspaceFileChange> changedFiles;
    ...
    public Builder projectExcludes(ImmutableList<Path> projectExcludes) {
      this.projectExcludes = projectExcludes;
      return this;
    }
    ...
    @CanIgnoreReturnValue
    public Builder changedFiles(ImmutableCollection<WorkspaceFileChange> changes) {
    ...
    public AffectedPackages build(Context context) {
      ...
      Preconditions.checkNotNull(projectExcludes, "projectExcludes");
      ...
      // removing source files may matter? What a bout changes to .bzl files?

      return new AffectedPackages(affectedPackages.build(), deletedPackages.build());
    }
