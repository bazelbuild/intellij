...
/** Resolve genfile imports for python files in Bazel. */
public class BazelPyGenfilesImportResolverStrategy extends AbstractPyImportResolverStrategy {
  ...
  protected QualifiedName toImportString(ArtifactLocation source) {
    ...
    if (source.isExternal || source.isSource || !source.relativePath.endsWith(".py")) {
      return null;
    }
