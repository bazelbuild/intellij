...
public class BlazeKotlinRunConfigureProducerTest extends BlazeRunConfigurationProducerTestCase {
    @Test
    public void testMainMethodIsRunnable() {
        ...
        PsiFile kotlinFile = createAndIndexFile(
    ...
    public void testMainClassInterpretedCorrectly() {
        ...
        PsiFile justMainFile = createAndIndexFile(
