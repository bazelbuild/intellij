...
def aswb_test_deps_dependencies():
    ...
    http_file(
        ...
        sha256 = "dd908e08dc9cb54e03a57a8f08d6e9ca69a1cd9962df6dea806763adcbcd8bde",
        downloaded_file_path = "bazel_central_registry.zip",
        url = "https://github.com/bazelbuild/bazel-central-registry/archive/7664af655c98dfb46bc6f55449fbff4d9d0531f4.zip",
        visibility = ["//:__subpackages__"],
    )
