...
def aswb_test_deps_dependencies():
    ...
    http_file(
        ...
        sha256 = "5d7972acbe85902a50349d2c10f18026c9c45d307270e1b9378050b47a1bfefb",
        downloaded_file_path = "bazel_central_registry.zip",
        url = "https://github.com/bazelbuild/bazel-central-registry/archive/7d4b0d7e11e20df95a00f0e47e740c7c594fabe9.zip",
        visibility = ["//:__subpackages__"],
    )
