...
def aswb_test_deps_dependencies():
    ...
    http_file(
        ...
        sha256 = "3028d68ae74027a5ec065c3e88c3b13b0d8fa1b9551a13f040cb4c1d72f9c290",
        downloaded_file_path = "bazel_central_registry.zip",
        url = "https://github.com/bazelbuild/bazel-central-registry/archive/03fcb0c9e8debb27f2f81735043372a58a26bee0.zip",
        visibility = ["//:__subpackages__"],
    )
