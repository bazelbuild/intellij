...
public class ProjectIndexingHistoryWrapper {
  ...
  public static ProjectIndexingHistoryWrapper create(
    ...
    // fakeProjectIndexingHistory(
    //     project,
    //     provider,
    //     fakeIndexingTimes(totalIndexingTime, totalUpdatingTime, scanFilesDuration)));
  }
  ...
  //   private ProjectDumbIndexingHistory fakeProjectIndexingHistory(
  //       Project project,
  //       ImmutableList<JsonFileProviderIndexStatistics> statistics,
  //       DumbIndexingTimes fakeIndexingTimes) {
  //     // this.project = project;
  //     // this.statistics = statistics;
  //     // this.fakeIndexingTimes = fakeIndexingTimes;
  //     return new ProjectDumbIndexingHistoryImpl();
  //   }

  //   private DumbIndexingTimes fakeIndexingTimes(
  ...
  //     return new DumbIndexingTimesImpl(1,2);
  //   }
}
