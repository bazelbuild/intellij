...
import com.google.idea.blaze.scala.ScalaBlazeRules.RuleTypes;

/** Scala-specific implementation of {@link JavaLikeLanguage}. */
public class ScalaJavaLikeLanguage implements JavaLikeLanguage {
  ...
  public ImmutableSet<Kind> getNonSourceKinds() {
    return ImmutableSet.of(RuleTypes.SCALA_IMPORT.getKind());
  }
}
