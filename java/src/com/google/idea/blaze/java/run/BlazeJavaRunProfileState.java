...
public final class BlazeJavaRunProfileState extends BlazeJavaDebuggableRunProfileState {
  ...
  protected ProcessHandler startProcess() throws ExecutionException {
    ...
    if (isLocalTest()
      ...
      WorkspaceRoot workspaceRoot = new WorkspaceRoot(new File(downloadDir, "google3"));
      ...
      if (getConfiguration().getTargetKind().getKindString().equals("android_local_test")) {
        commandBuilder
  ...
  private boolean isLocalTest() {
    ...
    return targetKind != null
        && (targetKind.getKindString().equals("android_local_test")
            || targetKind.getKindString().equals("java_test"));
  }
