...
public final class BlazeGoTestLocator implements SMTestLocator {
  ...
  private static List<Location> findTestPackage(Project project, String labelString) {
    ...
    PsiElement rule = getTargetRule(project, target, target.getKey().getLabel());
    return rule != null ? ImmutableList.of(new PsiLocation<>(rule)) : null;
  }

  @Nullable
  private static PsiElement getTargetRule(Project project, TargetIdeInfo target, Label label) {
