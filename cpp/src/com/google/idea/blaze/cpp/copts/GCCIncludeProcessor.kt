...
abstract class GCCIncludeProcessor(prefix: String) : IncludeProcessor(prefix) {

  override fun enabled(kind: OCCompilerKind): Boolean {
    return kind in listOf(GCCCompilerKind, ClangCompilerKind)
  }
}

class GCCDefaultIncludeProcessor : GCCIncludeProcessor("-I") {
...
class GCCSystemIncludeProcessor : GCCIncludeProcessor("-isystem") {
...
class GCCQuoteIncludeProcessor : GCCIncludeProcessor("-iquote") {
