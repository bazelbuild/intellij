...
public class IntelliJExtClient {
  ...
  public IntelliJExtClient(String socket) {
    DomainSocketAddress address = new DomainSocketAddress(socket);
  ...
  public static IntelliJExtClient create(String socket) {
  ...
  public IntelliJExtBlockingStub getStubSafe() {
    ...
    PingResponse unused = stub.ping(PingRequest.newBuilder().build());
    long delta = System.currentTimeMillis() - now;
    System.out.printf("Server ping: %dms%n", delta);
    return stub;
  }
}
